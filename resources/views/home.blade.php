        ...
        <div class="inbox_msg">
            <div class="inbox_people">
                ...
                <div class="inbox_chat">
                    ...
                    <div class="chat_list active_chat chat_style" id="chat_head" onclick="showThisChat({{$item->messages}}, {{$item->user_two}}, {{Auth::user()->id}}, {{ $item->id }})">
                        <div class="chat_people">
                            <div class="chat_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div>
                            <div class="chat_ib">
                                <h5>{{$item->u_two->name}}<span class="chat_date">MsgDate</span></h5>
                                <p>Click here to see the message</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
